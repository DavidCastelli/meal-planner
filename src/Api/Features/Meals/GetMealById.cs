...
public sealed class GetMealByIdController : ApiControllerBase
{
    ...
    [Tags("Manage Meals")]
    public async Task<Results<UnauthorizedHttpResult, NotFound, Ok<GetMealByIdDto>>> GetByIdAsync(int id, GetMealByIdHandler handler, CancellationToken cancellationToken)
    {
