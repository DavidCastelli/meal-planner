...
public sealed class AuthorizationTestFixture : CommonTestFixture
{
    ...
    private async Task InitializeAuthCookieAsync()
    {
        ...
        var email = TestDataSeeder.GetTestUser(1).Email;
        var password = TestDataSeeder.GetTestUserPassword(1);
